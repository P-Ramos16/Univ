    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (String line : inputComp.split("\n")){
                ...
                //  Colocar a linha temporária no Array de Companhias
            ...
            while (i < arrayVoos.size()) {
                ...
                for (ArrayList<String> linha : arrayComp) {
                    String sigla2 = linha.get(0).substring(0, 2);
                    if (sigla.equals(sigla2)) {
                        arrayTemp.add(linha.get(1));
                    }
                }
                if (arrayTemp.size() < 3) {
                    arrayTemp.add("?");
