...
var vm = function () {
    ...
    //---Variáveis locais
    var self = this;
    self.baseUri = ko.observable('http://192.168.160.58/Formula1/api/Search/Circuits');
    ...
    self.activate = function (id) {
        ...
        ajaxHelper('http://192.168.160.58/Formula1/api/circuits', 'GET').done(function (data) {
