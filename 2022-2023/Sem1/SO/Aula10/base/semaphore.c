...
{
    //  Buffer que mostra a operação a realizar no semafro
    //           semafero 0, down (-1), flags
    struct sembuf down = { 0, -1, 0 };                                                      /* specific down operation */
    // troca o semafro index o por o do semafero desejado (sindex)
