...
void servReceive(MESSAGE *msg, int *ClientID)
{
...
void servSend(MESSAGE *msg, int *ClientID)
{
    /* send a message */
    container.msg = *msg;
...
void cliSend(MESSAGE *msg, int *ClientID)
{
...
void cliReceive(MESSAGE *msg, int *ClientID)
{
