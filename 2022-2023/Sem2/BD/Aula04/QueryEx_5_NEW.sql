...
//  ID Comprovativo faz sentido estar ligado à instituição???

CREATE TABLE Conferencias_INSTITUICAO (
    [Codigo]		[int]           NOT NULL	PRIMARY KEY,
    [Nome]          [varchar](256)	NOT NULL,
    [Morada]	  	[varchar](1024)	NOT NULL	UNIQUE,
	[IDComprovat]	[int]			NOT NULL	UNIQUE
);

//  Estas duas podiam ser eleminadas mas mais vale a pena as ter cá
...
//  É pá era engraçoso se isto desse para fazer assim mas não faço a minima ideia se posso
//  UNIQUE afeta null? Se sim tenho de tirar pq assim não podia ter mais do que um null
...
//  Mesma coisa com nulls diferentes (UNIQUE)
